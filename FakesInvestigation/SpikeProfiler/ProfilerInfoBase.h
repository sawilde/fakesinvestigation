...
public:
	CComQIPtr<ICorProfilerInfo> m_pProflerInfo;
	CComQIPtr<ICorProfilerInfo2> m_pProflerInfo2;
	CComQIPtr<ICorProfilerInfo3> m_pProflerInfo3;
	CComQIPtr<ICorProfilerInfo4> m_pProflerInfo4;
...
public: // ICorProfilerInfo
	virtual HRESULT STDMETHODCALLTYPE GetClassFromObject(
		...
		return m_pProflerInfo->GetClassFromObject(objectId, pClassId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetClassFromToken(
		...
		return m_pProflerInfo->GetClassFromToken(moduleId, typeDef, pClassId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetCodeInfo(
		...
		return m_pProflerInfo->GetCodeInfo(functionId, pStart, pcSize);
	}

	virtual HRESULT STDMETHODCALLTYPE GetEventMask(
		/* [out] */ DWORD *pdwEvents){
		ATLTRACE(_T("GetEventMask"));
		return m_pProflerInfo->GetEventMask(pdwEvents);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionFromIP(
		...
		return m_pProflerInfo->GetFunctionFromIP(ip, pFunctionId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionFromToken(
		...
		return m_pProflerInfo->GetFunctionFromToken(moduleId, token, pFunctionId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetHandleFromThread(
		...
		return m_pProflerInfo->GetHandleFromThread(threadId, phThread);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetObjectSize(
		...
		return m_pProflerInfo->GetObjectSize(objectId, pcSize);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE IsArrayClass(
		...
		return m_pProflerInfo->IsArrayClass(classId, pBaseElemType, pBaseClassId, pcRank);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetThreadInfo(
		...
		return m_pProflerInfo->GetThreadInfo(threadId, pdwWin32ThreadId);
	}

	virtual HRESULT STDMETHODCALLTYPE GetCurrentThreadID(
		/* [out] */ ThreadID *pThreadId){
		ATLTRACE(_T("GetCurrentThreadID"));
		return m_pProflerInfo->GetCurrentThreadID(pThreadId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetClassIDInfo(
		...
		return m_pProflerInfo->GetClassIDInfo(classId, pModuleId, pTypeDefToken);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionInfo(
		...
		return m_pProflerInfo->GetFunctionInfo(functionId, pClassId, pModuleId, pToken);
	}

	virtual HRESULT STDMETHODCALLTYPE SetEventMask(
		/* [in] */ DWORD dwEvents){
		ATLTRACE(_T("SetEventMask"));
		return m_pProflerInfo->SetEventMask(dwEvents);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetEnterLeaveFunctionHooks(
		...
		return m_pProflerInfo->SetEnterLeaveFunctionHooks(pFuncEnter, pFuncLeave, pFuncTailcall);
	}

	virtual HRESULT STDMETHODCALLTYPE SetFunctionIDMapper(
		/* [in] */ FunctionIDMapper *pFunc){
		ATLTRACE(_T("SetFunctionIDMapper"));
		return m_pProflerInfo->SetFunctionIDMapper(pFunc);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetTokenAndMetaDataFromFunction(
		...
		return m_pProflerInfo->GetTokenAndMetaDataFromFunction(functionId, riid, ppImport, pToken);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetModuleInfo(
		...
		return m_pProflerInfo->GetModuleInfo(moduleId, ppBaseLoadAddress, cchName, pcchName, szName, pAssemblyId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetModuleMetaData(
		...
		return m_pProflerInfo->GetModuleMetaData(moduleId, dwOpenFlags, riid, ppOut);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetILFunctionBody(
		...
		return m_pProflerInfo->GetILFunctionBody(moduleId, methodId, ppMethodHeader, pcbMethodSize);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetILFunctionBodyAllocator(
		...
		return m_pProflerInfo->GetILFunctionBodyAllocator(moduleId, ppMalloc);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetILFunctionBody(
		...
		return m_pProflerInfo->SetILFunctionBody(moduleId, methodid, pbNewILMethodHeader);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetAppDomainInfo(
		...
		return m_pProflerInfo->GetAppDomainInfo(appDomainId, cchName, pcchName, szName, pProcessId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetAssemblyInfo(
		...
		return m_pProflerInfo->GetAssemblyInfo(assemblyId, cchName, pcchName, szName, pAppDomainId, pModuleId);
	}

	virtual HRESULT STDMETHODCALLTYPE SetFunctionReJIT(
		/* [in] */ FunctionID functionId){
		ATLTRACE(_T("SetFunctionReJIT"));
		return m_pProflerInfo->SetFunctionReJIT(functionId);
	}

	virtual HRESULT STDMETHODCALLTYPE ForceGC(void){
		ATLTRACE(_T("GetClassFromObject"));
		return m_pProflerInfo->ForceGC();
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetILInstrumentedCodeMap(
		...
		return m_pProflerInfo->SetILInstrumentedCodeMap(functionId, fStartJit, cILMapEntries, rgILMapEntries);
	}

	virtual HRESULT STDMETHODCALLTYPE GetInprocInspectionInterface(
		/* [out] */ IUnknown **ppicd){
		ATLTRACE(_T("GetInprocInspectionInterface"));
		return m_pProflerInfo->GetInprocInspectionInterface(ppicd);
	}

	virtual HRESULT STDMETHODCALLTYPE GetInprocInspectionIThisThread(
		/* [out] */ IUnknown **ppicd){
		ATLTRACE(_T("GetInprocInspectionIThisThread"));
		return m_pProflerInfo->GetInprocInspectionIThisThread(ppicd);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetThreadContext(
		...
		return m_pProflerInfo->GetThreadContext(threadId, pContextId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE BeginInprocDebugging(
		...
		return m_pProflerInfo->BeginInprocDebugging(fThisThreadOnly, pdwProfilerContext);
	}

	virtual HRESULT STDMETHODCALLTYPE EndInprocDebugging(
		/* [in] */ DWORD dwProfilerContext){
		ATLTRACE(_T("EndInprocDebugging"));
		return m_pProflerInfo->EndInprocDebugging(dwProfilerContext);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetILToNativeMapping(
		...
		return m_pProflerInfo->GetILToNativeMapping(functionId, cMap, pcMap, map);
	}
...
public: //ICorProfilerInfo2
	virtual HRESULT STDMETHODCALLTYPE DoStackSnapshot(
		...
		return m_pProflerInfo2->DoStackSnapshot(thread, callback, infoFlags, clientData, context, contextSize);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetEnterLeaveFunctionHooks2(
		...
		return m_pProflerInfo2->SetEnterLeaveFunctionHooks2(pFuncEnter, pFuncLeave, pFuncTailcall);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionInfo2(
		...
		return m_pProflerInfo2->GetFunctionInfo2(funcId, frameInfo, pClassId, pModuleId, pToken, cTypeArgs, pcTypeArgs, typeArgs);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetStringLayout(
		...
		return m_pProflerInfo2->GetStringLayout(pBufferLengthOffset, pStringLengthOffset, pBufferOffset);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetClassLayout(
		...
		return m_pProflerInfo2->GetClassLayout(classID, rFieldOffset, cFieldOffset, pcFieldOffset, pulClassSize);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetClassIDInfo2(
		...
		return m_pProflerInfo2->GetClassIDInfo2(classId, pModuleId, pTypeDefToken, pParentClassId, cNumTypeArgs, pcNumTypeArgs, typeArgs);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetCodeInfo2(
		...
		return m_pProflerInfo2->GetCodeInfo2(functionID, cCodeInfos, pcCodeInfos, codeInfos);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetClassFromTokenAndTypeArgs(
		...
		return m_pProflerInfo2->GetClassFromTokenAndTypeArgs(moduleID, typeDef, cTypeArgs, typeArgs, pClassID);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionFromTokenAndTypeArgs(
		...
		return m_pProflerInfo2->GetFunctionFromTokenAndTypeArgs(moduleID, funcDef, classId, cTypeArgs, typeArgs, pFunctionID);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE EnumModuleFrozenObjects(
		...
		ATLTRACE(_T("GetClassFromObject"));
		return m_pProflerInfo2->EnumModuleFrozenObjects(moduleID, ppEnum);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetArrayObjectInfo(
		...
		return m_pProflerInfo2->GetArrayObjectInfo(objectId, cDimensions, pDimensionSizes, pDimensionLowerBounds, ppData);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetBoxClassLayout(
		...
		return m_pProflerInfo2->GetBoxClassLayout(classId, pBufferOffset);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetThreadAppDomain(
		...
		return m_pProflerInfo2->GetThreadAppDomain(threadId, pAppDomainId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetRVAStaticAddress(
		...
		return m_pProflerInfo2->GetRVAStaticAddress(classId, fieldToken, ppAddress);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetAppDomainStaticAddress(
		...
		return m_pProflerInfo2->GetAppDomainStaticAddress(classId, fieldToken, appDomainId, ppAddress);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetThreadStaticAddress(
		...
		return m_pProflerInfo2->GetThreadStaticAddress(classId, fieldToken, threadId, ppAddress);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetContextStaticAddress(
		...
		return m_pProflerInfo2->GetContextStaticAddress(classId, fieldToken, contextId, ppAddress);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetStaticFieldInfo(
		...
		return m_pProflerInfo2->GetStaticFieldInfo(classId, fieldToken, pFieldInfo);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetGenerationBounds(
		...
		return m_pProflerInfo2->GetGenerationBounds(cObjectRanges, pcObjectRanges, ranges);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetObjectGeneration(
		...
		return m_pProflerInfo2->GetObjectGeneration(objectId, range);
	}

	virtual HRESULT STDMETHODCALLTYPE GetNotifiedExceptionClauseInfo(
		/* [out] */ COR_PRF_EX_CLAUSE_INFO *pinfo){
		ATLTRACE(_T("GetNotifiedExceptionClauseInfo"));
		return m_pProflerInfo2->GetNotifiedExceptionClauseInfo(pinfo);
	}
...
public: // ICorProfilerInfo3
	virtual HRESULT STDMETHODCALLTYPE EnumJITedFunctions(
		...
		return m_pProflerInfo3->EnumJITedFunctions(ppEnum);
	}

	virtual HRESULT STDMETHODCALLTYPE RequestProfilerDetach(
		/* [in] */ DWORD dwExpectedCompletionMilliseconds){
		ATLTRACE(_T("RequestProfilerDetach"));
		return m_pProflerInfo3->RequestProfilerDetach(dwExpectedCompletionMilliseconds);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetFunctionIDMapper2(
		...
		return m_pProflerInfo3->SetFunctionIDMapper2(pFunc, clientData);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetStringLayout2(
		...
		return m_pProflerInfo3->GetStringLayout2(pStringLengthOffset, pBufferOffset);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetEnterLeaveFunctionHooks3(
		...
		return m_pProflerInfo3->SetEnterLeaveFunctionHooks3(pFuncEnter3, pFuncLeave3, pFuncTailcall3);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE SetEnterLeaveFunctionHooks3WithInfo(
		...
		return m_pProflerInfo3->SetEnterLeaveFunctionHooks3WithInfo(pFuncEnter3WithInfo, pFuncLeave3WithInfo, pFuncTailcall3WithInfo);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionEnter3Info(
		...
		return m_pProflerInfo3->GetFunctionEnter3Info(functionId, eltInfo, pFrameInfo, pcbArgumentInfo, pArgumentInfo);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionLeave3Info(
		...
		return m_pProflerInfo3->GetFunctionLeave3Info(functionId, eltInfo, pFrameInfo, pRetvalRange);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionTailcall3Info(
		...
		return m_pProflerInfo3->GetFunctionTailcall3Info(functionId, eltInfo, pFrameInfo);
	}

	virtual HRESULT STDMETHODCALLTYPE EnumModules(
		/* [out] */ ICorProfilerModuleEnum **ppEnum){
		ATLTRACE(_T("EnumModules"));
		return m_pProflerInfo3->EnumModules(ppEnum);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetRuntimeInformation(
		...
		return m_pProflerInfo3->GetRuntimeInformation(pClrInstanceId, pRuntimeType, pMajorVersion,
	...
	virtual HRESULT STDMETHODCALLTYPE GetThreadStaticAddress2(
		...
		return m_pProflerInfo3->GetThreadStaticAddress2(classId,
	...
	virtual HRESULT STDMETHODCALLTYPE GetAppDomainsContainingModule(
		...
		return m_pProflerInfo3->GetAppDomainsContainingModule(moduleId,
	...
	virtual HRESULT STDMETHODCALLTYPE GetModuleInfo2(
		...
		return m_pProflerInfo3->GetModuleInfo2(moduleId, ppBaseLoadAddress, cchName,
...
public: // ICorProfilerInfo4
	...
	virtual HRESULT STDMETHODCALLTYPE RequestReJIT(
		...
		return m_pProflerInfo4->RequestReJIT(cFunctions, moduleIds, methodIds);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE RequestRevert(
		...
		return m_pProflerInfo4->RequestRevert(cFunctions, moduleIds, methodIds, status);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetCodeInfo3(
		...
		return m_pProflerInfo4->GetCodeInfo3(functionID, reJitId, cCodeInfos, pcCodeInfos, codeInfos);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetFunctionFromIP2(
		...
		return m_pProflerInfo4->GetFunctionFromIP2(ip, pFunctionId, pReJitId);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetReJITIDs(
		...
		ATLTRACE(_T("GetClassFromObject"));
		return m_pProflerInfo4->GetReJITIDs(functionId, cReJitIds, pcReJitIds, reJitIds);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetILToNativeMapping2(
		...
		return m_pProflerInfo4->GetILToNativeMapping2(functionId, reJitId, cMap, pcMap, map);
	}

	virtual HRESULT STDMETHODCALLTYPE EnumJITedFunctions2(
		/* [out] */ ICorProfilerFunctionEnum **ppEnum){
		ATLTRACE(_T("EnumJITedFunctions2"));
		return m_pProflerInfo4->EnumJITedFunctions2(ppEnum);
	}
	...
	virtual HRESULT STDMETHODCALLTYPE GetObjectSize2(
		...
		return m_pProflerInfo4->GetObjectSize2(objectId, pcSize);
	}
